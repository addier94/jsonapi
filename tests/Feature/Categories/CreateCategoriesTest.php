...
class CreateCategoriesTest extends TestCase
{
    ...
    public function name_is_required()
    {
        ...
        $this->jsonApi()->withData([
            ...
            ->assertStatus(422)
            ->assertSee('data\/attributes\/name'); //with error inside data/attributes/name
    }
    /** @test */
    ...
    {
        Category::factory()->create(['slug' => 'name-slug']);

        $category = Category::factory()->raw(['slug' => 'name-slug']);
